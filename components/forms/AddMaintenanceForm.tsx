  ...
  if (subscriptionPlan === 'free') {
    return (
      <div className="text-center py-10">
        ...
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Family Plan Required</h3>
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-6 max-w-xs mx-auto">
          Upgrade to Family to log maintenance records, get service reminders, and track upcoming service dates.
        </p>
        <a
          href="/pricing#family"
