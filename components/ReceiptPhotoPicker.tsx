          ...
          >
            ...
            {!isUploading && f.status !== 'uploading' && f.status !== 'compressing' && (
              <button
                ...
                className="absolute top-0.5 right-0.5 w-7 h-7 bg-red-600 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 focus:opacity-100 transition-opacity"
              >
                <svg className="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
