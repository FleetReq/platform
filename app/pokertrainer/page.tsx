...
const STATIC_SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    steps: ['potOdds', 'breakeven', 'outs', 'equity', 'decision'],
    explanations: {
      potOdds: 'Pot is $50, you call $20. Divide: 50 ÷ 20 = 2.5. Your pot odds are 2.5:1.',
      breakeven: 'Your 2.5:1 pot odds = risking $20 for a $70 pot. $20 ÷ $70 ≈ 29%. You need at least 29% equity — now go find out if you have it.',
      outs: '13 hearts in the deck. You can see 4 of them (6♥ 7♥ T♥ 4♥). That leaves 9 unseen hearts that complete your flush.',
      equity: 'Two cards to come → Rule of 4: 9 × 4 = 36%. Your equity (36%) beats the 29% needed — profitable call.',
      decision: 'Call. 36% equity vs 29% breakeven. Your flush draw has the edge here — calling is +EV over time.',
    },
  },
  {
    id: 9,
